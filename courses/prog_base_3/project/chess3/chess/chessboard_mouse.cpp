...
{
    iSelectedTileX = move.from % 8;
    iSelectedTileY = move.from / 8;
    int tileX = move.to % 8;
    int tileY = move.to / 8;

    iSelectedFigure = indexTable[iSelectedTileY][iSelectedTileX];
    ...
    int ret = chessEng->userMove (move);
